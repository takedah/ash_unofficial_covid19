...
class ScrapeChildReservationStatus(ScrapeReservationStatus):
    ...
    def __init__(self, html_url: str):
        ...
        table_data = self.get_table_data(downloaded_html, "tablepress-11-no-2")
    ...
    def _extract_status_data(self, row: list) -> Optional[dict]:
        ...
        try:
            ...
            memo = family["text"] + " " + not_family["text"] + " " + row[10]
            memo = memo.strip()
