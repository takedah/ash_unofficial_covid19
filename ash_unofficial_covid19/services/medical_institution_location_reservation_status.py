...
class MedicalInstitutionLocationReservationStatusService(Service):
    ...
    def find(self, name: str, is_pediatric: bool = False) -> MedicalInstitutionLocationReservationStatus:
        ...
        state = (
            ...
            + "book_at_call_center,area,med.memo,med.target_age,latitude,longitude,"
            + "status,reserve.target_age AS reservation_status_target_age,"
            + "reserve.target_family,reserve.target_not_family,reserve.target_suberbs,"
            + "reserve.target_other,inoculation_time,reserve.memo AS reservation_status_memo "
