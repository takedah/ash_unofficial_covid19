from ash_unofficial_covid19.models.child_reservation_status import (
    ChildReservationStatus,
    ChildReservationStatusFactory,
    ChildReservationStatusLocation,
    ChildReservationStatusLocationFactory,
)


class TestChildReservationStatus:
    def test_create(self):
        ...
        # ChildReservationStatusクラスのオブジェクトが生成できるか確認する。
        reservation_status = factory.create(**test_data)
        assert isinstance(reservation_status, ChildReservationStatus)


class TestChildReservationStatusLocation:
    def test_create(self):
        test_data = {
            "area": "西地区",
            "medical_institution_name": "旭川赤十字病院",
        ...
        # ChildReservationStatusLocationクラスのオブジェクトが生成できるか確認する。
