...
def test_get_medical_institution_list(view):
    ...
    assert (
        results[0]["url"]
        == "JA%E5%8C%97%E6%B5%B7%E9%81%93%E5%8E%9A%E7%94%9F%E9%80%A3%20%E6%97%AD%E5%B7%9D%E5%8E%9A%E7%94%9F%E7%97%85%E9%99%A2"
    )
    assert results[1]["name"] == "市立旭川病院"
...
def test_search_by_gps(view):
    ...
    assert most_farthest.medical_institution_name == "JA北海道厚生連 旭川厚生病院"
